			...
			<div class="ml-4 pl-4">
				...
				<div class="mt-4 pb-4 flex flex-row items-center border-b border-gray-600">
					...
					<input
						type="button"
						value="Manage"
						class="bg-gray-800 border border-gray-600 hover:border-purple-500 text-gray-100 font-bold py-2 px-4 rounded-lg mr-4 transition-all"
					/>
				</div>
				...
				<div class="mt-4 pb-4 flex flex-row items-center border-b border-gray-600">
					...
					<input
						type="button"
						value="Disable"
						class="bg-gray-800 border border-gray-600 hover:border-gray-400 text-red-500 font-bold py-2 px-4 rounded-lg mr-4 transition-all"
					/>
				</div>
