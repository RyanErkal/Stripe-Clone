...
import { newPayment } from "./firebase";
...
export default function NewPaymentModalContent({ closeModal }) {
	...
	async function handleSubmit(e) {
		e.preventDefault();
		newPayment(
			newPaymentFormData.order,
			newPaymentFormData.date,
			newPaymentFormData.name,
			newPaymentFormData.amount,
			newPaymentFormData.status,
			newPaymentFormData.location,
			newPaymentFormData.items,
			newPaymentFormData.type,
